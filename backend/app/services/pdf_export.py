...
def _styles() -> dict[str, ParagraphStyle]:
    ...
    return {
        "body": base,
        "name": ParagraphStyle(
            "name", parent=base, fontName=_FONT_BOLD, fontSize=_NAME_PT,
            leading=_NAME_PT * 1.1, spaceAfter=2,
        ),
        "headline": ParagraphStyle(
            "headline", parent=base, fontSize=_HEADLINE_PT,
            leading=_HEADLINE_PT * 1.2, textColor=_LIGHT, spaceAfter=2,
        ),
        "contact": ParagraphStyle(
            "contact", parent=base, fontSize=_SMALL_PT,
            leading=_SMALL_PT * 1.25, textColor=_LIGHT, spaceAfter=1,
        ),
        "heading": ParagraphStyle(
            "heading", parent=base, fontName=_FONT_BOLD, fontSize=11,
            leading=13, spaceBefore=10, spaceAfter=3, textColor=_INK,
        ),
        "entry1": ParagraphStyle(
            "entry1", parent=base, fontName=_FONT_BOLD, spaceAfter=0,
        ),
        "bullet": ParagraphStyle(
            "bullet", parent=base, leftIndent=12, bulletIndent=0, spaceAfter=2,
        ),
    }
